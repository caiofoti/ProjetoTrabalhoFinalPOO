...
public class TelaIncendio extends JPanel {
	...
	public TelaIncendio() {
		...
		imagemPedidosInternos.setIcon(new ImageIcon(TelaIncendio.class.getResource("/figuras/TelaPedidos4.png")));
		...
		panel.add(labelTexto1, "cell 0 5");
		...
		panel.add(labelTexto2, "cell 0 6");
		...
		panel.add(labelIrregularidade, "flowx,cell 0 10");
		...
		panel.add(labelDetalhesIrregularidade, "cell 0 11");
		...
		panel.add(irregArea, "cell 0 12,grow");
		...
		panel.add(labelAsterisco1, "cell 0 14");
		...
		panel.add(comboSist, "cell 0 15,alignx left");
		comboSist.addItem("");
		...
		panel.add(labelLocal, "flowx,cell 0 17");
		...
		panel.add(labelAsterisco2, "cell 0 17");
		...
		panel.add(LabelObservDetalhes, "cell 0 25");
		...
		panel.add(obsArea, "cell 0 26,grow");
		
		 buttonEnviar = new JButton("Envio");
		buttonEnviar.setFont(new Font("Arial", Font.BOLD, 12));
		panel.add(buttonEnviar, "flowx,cell 0 28,alignx center,aligny center");
		
		 buttonCancelar = new JButton("Cancelar");
		buttonCancelar.setFont(new Font("Arial", Font.BOLD, 12));
		panel.add(buttonCancelar, "cell 0 28,alignx center,aligny center");
