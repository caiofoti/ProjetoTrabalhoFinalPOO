...
public class TelaCortina extends JPanel {
	...
	public TelaCortina() {
		...
		panel.add(Ramal_Telef, "flowx,cell 0 15");
		...
		panel.add(labelAstericos3, "cell 0 19");
		
		fieldEmail = new JTextField();
		fieldEmail.setColumns(10);
		panel.add(fieldEmail, "cell 0 20,growx");
		
		JLabel local = new JLabel("Local (sala e prédio)");
		local.setFont(new Font("Arial", Font.BOLD, 14));
		panel.add(local, "flowx,cell 0 22");
		...
		panel.add(labelAsterisco5, "cell 0 25");
		...
		panel.add(labelAsterisco6, "cell 0 29");
		
		fieldResp = new JTextField();
		fieldResp.setColumns(10);
		panel.add(fieldResp, "cell 0 30,growx");
		
		 buttonEnviar = new JButton("Enviar");
		buttonEnviar.setFont(new Font("Arial", Font.BOLD, 12));
		panel.add(buttonEnviar, "flowx,cell 0 32,alignx center,aligny center");
		
		 buttonCancelar = new JButton("Cancelar");
		buttonCancelar.setFont(new Font("Arial", Font.BOLD, 12));
		panel.add(buttonCancelar, "cell 0 32,alignx center,aligny center");
		
		JLabel imagemPedidosInternos = new JLabel("");
		imagemPedidosInternos.setIcon(new ImageIcon(TelaCortina.class.getResource("/figuras/TelaPedidos4.png")));
		panel.add(imagemPedidosInternos, "cell 0 1");
